...
import com.myclass.controller.QuanLyPhongTro;

/**
 *
 * @author hoang
 */
public class PhongTroJPanel extends javax.swing.JPanel {

    /**
     * Creates new form KhachThueJPanel
     */
    public PhongTroJPanel() {
        initComponents();

        QuanLyPhongTro controller = new QuanLyPhongTro(jpnView, jbtThem, jtfTimKiem);
